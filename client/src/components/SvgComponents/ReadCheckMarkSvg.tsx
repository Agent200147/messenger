...
const ReadCheckMarkSvg: FC<ReadCheckMarkProp> = ({ isRead }) => {
    return (
        isRead
            ? (
                <svg width="auto" height="auto" viewBox="0 0 29 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            : (
            <svg width="auto" height="auto" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
